//go:generate go tool viewer --type=User,Node,PreAuthKey,PostureIdentity,NodeAttribute
package types

//go:generate go run tailscale.com/cmd/viewer --type=User,Node,PreAuthKey,PostureIdentity,NodeAttribute
