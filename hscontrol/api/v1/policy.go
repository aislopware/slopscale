...
func handleGetPolicy(b Backend) (*getPolicyOutput, error) {
...
func getPolicyFromFile(b Backend) (*getPolicyOutput, error) {
...
func handleCheckPolicy(b Backend, in *checkPolicyInput) (*checkPolicyOutput, error) {
