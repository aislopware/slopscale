...
func init() {
	...
	setDERPCmd.Flags().String("region-name", "", "Name of the embedded relay's region; empty takes the code")
	...
	setDERPCmd.Flags().String("ipv4", "", "Public IPv4 published for the embedded relay; empty leaves it to DNS")
	setDERPCmd.Flags().String("ipv6", "", "Public IPv6 published for the embedded relay; empty leaves it to DNS")
	...
	addDERPRelayCmd.Flags().String("name", "", "Region name; empty takes the code")
