// Vendored from cloudflare/kumo (lint/no-primitive-colors.js, MIT licence,
// Copyright (c) 2026 Cloudflare, Inc.). The rules are not published on npm.
// Only the theme file paths changed: they now point at the installed package.
...
function parseKumoSemanticColors() {
  const themeFiles = [
    resolve(__dirname, "../node_modules/@cloudflare/kumo/dist/styles/theme-kumo.css"),
    resolve(__dirname, "../node_modules/@cloudflare/kumo/dist/styles/theme-fedramp.css"),
  ];
