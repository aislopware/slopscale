...
| Role            | Users, devices, keys, settings | Policy and routes | Reads everything | Assigns roles |
| --------------- | ------------------------------ | ----------------- | ---------------- | ------------- |
| `owner`         | write                          | write             | yes              | yes           |
| `admin`         | write                          | write             | yes              | yes           |
| `network-admin` | read                           | write             | yes              | no            |
| `it-admin`      | write                          | read              | yes              | no            |
| `auditor`       | read                           | read              | yes              | no            |
| `member`        | none                           | none              | no               | no            |
