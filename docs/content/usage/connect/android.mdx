...
description: "Point the Tailscale Android app at your slopscale server with Use an alternate server, then sign in through the browser or with a pre-auth key."
sidebar:
  label: "Android"
---
