---
title: "Connecting a Windows client"
description: "Connect the Tailscale Windows client with tailscale login, keep it running unattended, and reset a registration that keeps expiring."
sidebar:
  label: "Windows"
---
