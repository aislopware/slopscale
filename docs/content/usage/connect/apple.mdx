---
title: "Connecting an Apple client"
description: "Connect the Tailscale clients for iOS, macOS and tvOS to your slopscale server by setting a custom coordination server before signing in."
sidebar:
  label: "Apple"
---
