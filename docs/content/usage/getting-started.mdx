...
description: "First steps with the slopscale CLI: reach the server's socket, create and list users, and register a node through the browser or a pre-auth key."
---
