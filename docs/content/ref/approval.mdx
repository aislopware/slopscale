---
title: "Device and user approval"
description: "Make new machines and users wait for an administrator with the device and user approval switches, cap key expiry, and approve from the CLI or API."
---
...
`postureIdentityOn`, belongs to [device trust](/ref/device-trust) and lets
...
An [invited user](/ref/console#inviting-users) is created approved whatever
