...
The title and the logo may be set on their own. Renaming without a logo leaves
the built-in mark in place; a logo without a rename keeps the name Slopscale.
