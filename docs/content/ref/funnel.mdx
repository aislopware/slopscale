---
title: "Funnel"
description: "Expose a machine's service to the internet with tailscale funnel through an ingress node you run, with the attribute, certificates and DNS it needs."
---
