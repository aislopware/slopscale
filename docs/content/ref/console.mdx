---
title: "Admin console"
description: "Sign in to the built-in admin console through your identity provider, invite users, end console sessions, find each page, and build it from source."
---
...
collapses it to an icon rail. *Quick search*, or <kbd>⌘</kbd> <kbd>K</kbd> / <kbd>Ctrl</kbd> <kbd>K</kbd>,
...
- **Machines**: every node with its owner or tags, addresses, status and
  ...
  with a switch), sharing and the global exit node switch with its failover
  priority, plus rename, tag,
