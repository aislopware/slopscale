---
title: "Running slopscale in a container"
description: "Run slopscale from its container image with Docker or Compose: config and data volumes, ports, the health check, and the debug image with a shell."
sidebar:
  label: "Container"
---
...
1. Create a directory on the container host to store slopscale's [configuration](/ref/configuration) and the SQLite database:
