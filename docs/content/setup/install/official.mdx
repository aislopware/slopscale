...
description: "Install slopscale from the signed apt repository on Debian and Ubuntu, or from a standalone Linux binary with your own user and systemd service."
---
