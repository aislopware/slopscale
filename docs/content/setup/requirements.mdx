---
title: "Requirements"
description: "What a slopscale server needs: a public address, HTTPS on port 443, the ports the DERP relay and metrics use, and the paths these docs assume."
sidebar:
...
- A reasonably modern Linux or BSD based operating system. Release binaries and container images cover Linux
  (amd64, arm64, armv7); macOS and FreeBSD are [built from source](/setup/install/source).
