---
title: "Contributing"
description: "Slopscale takes a new feature only after a design discussion and with integration tests, and welcomes bug and documentation fixes without one."
---
