...
- Audit events of a user signed in through the identity provider now carry the user's display name or email rather than an empty name that left the console showing the session id in its place, and user targets are named the same way
